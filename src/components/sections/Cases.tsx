          ...
          {CASES.map((c, idx) => (
            <Reveal key={idx} delay={0.05 * idx} className="h-full w-full">
              <TiltCard className="h-full w-full rounded-[var(--radius-lg)]">
                <article className="relative flex h-full min-h-[420px] flex-col overflow-hidden rounded-[26px] border border-[var(--border)] bg-[var(--card)] sm:rounded-[var(--radius-lg)]">
                  {c.comingSoon ? (
                      ...
                      <div className="flex flex-1 flex-col px-5 pb-5 pt-4">
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-2">
                          ...
                          <a
                            href={c.href ?? "#"}
                            className={[
                              "group ml-auto inline-flex h-11 w-11 items-center justify-center rounded-full",
